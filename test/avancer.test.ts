...
describe('Un Rover peut avancer', () => {
  ...
  test('ETANT DONNE un Rover orienté Sud aterrissant en (5, 5) ' +
    'QUAND on le fait avancer ' +
    'ALORS il passe en (5, 6) et garde son orientation Sud', () => {
  ...
  test('ETANT DONNE un Rover orienté Est aterrissant en (5, 5) ' +
    'QUAND on le fait avancer ' +
    'ALORS il passe en (6, 5) et garde son orientation Est', () => {
  ...
  test('ETANT DONNE un Rover orienté Ouest aterrissant en (5, 5) ' +
    'QUAND on le fait avancer ' +
    'ALORS il passe en (4, 5) et garde son orientation Ouest', () => {
